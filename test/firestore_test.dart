    ...
    group('$Firestore', () {
      ...
      group('$DocumentReference', () {
        ...
        test('get set', () {
          ...
          data.setFieldValue(
              'deleteFieldValue', Firestore.fieldValues.delete());
          data.setList(
        ...
        test('update sub fields', () async {
          var ref = app.firestore().document('tests/set_options');
          await ref
              .setData(DocumentData.fromMap({'created': 1, 'modified': 2}));
          await ref.updateData(UpdateData.fromMap({
            'modified': 22,
            'added': 3,
      ...
      group('$DocumentQuery', () {
        ...
        test('query filter with timestamp', () async {
          ...
          await doc2.setData(
            DocumentData.fromMap({
              'createdAt':
                  Timestamp.fromDateTime(now.add(Duration(seconds: 10)))
            }),
          );
        ...
        test('query filter with list object', () async {
          ...
          // complex object
          var querySnapshot =
              await collRef.where('sub', isEqualTo: ['a']).get();
        ...
        test('order and limits', () async {
          ...
          // desc
          querySnapshot =
              await collRef.orderBy('value', descending: true).get();
          list = querySnapshot.documents;
          expect(list!.length, 2);
